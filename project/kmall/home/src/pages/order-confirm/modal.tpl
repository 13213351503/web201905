            ...
            <div class="form">
                <div class="form-box">
                    ...
                    <div class="form-item">
                        ...
                        <input type="text" class="form-content" name="address" value="{{address}}" placeholder="请输入详细地址到门牌号" >
                    </div>
                    <div class="form-item">
                        <label for="" class="form-lable">
                            <i class="fa fa-phone"></i>
                        </label>
                        <input type="text" class="form-content" name="phone" value="{{phone}}" placeholder="请输入手机号" >
                    </div>
                    <div class="form-item">
                        <label for="" class="form-lable">
                            <i class="fa fa-envelope"></i>
                        </label>
                        <input type="text" class="form-content" name="zip" value="{{zip}}" placeholder="请输入邮编,如100001" >
                    </div>      
                    <div class="btn-item">
